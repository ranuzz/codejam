...
if config_env() == :prod do
  ...
  #
  #     config :codejam_web, CodejamWeb.Endpoint, server: true
  #
  ...
  config :codejam, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
end
