defmodule Codejam.Accounts do
  ...
  alias Codejam.Accounts.{User, UserToken, UserNotifier, Membership, Integration}
  ...
  """
  def get_user_invited_memberships(user) do
    Repo.all(Membership.user_email_query(user.email))
  end

  def invite_member(email, organization_id) do
  ...
  def create_github_integration(token, organization_id) do
